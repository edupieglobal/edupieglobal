...
@app.route('/delete_all_responses', methods=['DELETE'])
def delete_all_responses():
    """API endpoint to delete all student responses from the database."""
    try:
        print("delete_all_responses")
        students_collection.delete_many({})
  # Deletes all documents
        return {'message': 'All responses have been deleted successfully.'}, 200
    except Exception as e:
